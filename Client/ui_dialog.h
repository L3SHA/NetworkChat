...
public:
    ...
    {
        Dialog->setWindowTitle(QApplication::translate("Dialog", "Lab2 client", 0));
        leHost->setText(QApplication::translate("Dialog", "127.0.0.1", 0));
        leName->setText(QApplication::translate("Dialog", "MyName", 0));
        ...
        cbToAll->setText(QApplication::translate("Dialog", "To ALL", 0));
    } // retranslateUi
